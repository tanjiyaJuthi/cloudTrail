            ...
            <Modal.Backdrop>
                <Modal.Container>
                    <Modal.Dialog className="sm:max-w-100 rounded-none">
                        ...
                        <Modal.Body>
                            <p>
                                {`Are you sure you want to delete "${destination.destinationName}"? This action cannot be undone and will permanently remove this travel package from the system.`}
                            </p>
                        </Modal.Body>

                        <Modal.Footer>
                            <Button 
                                slot="close"        className="bg-transparent text-gray-900 rounded-none border border-gray-500 flex gap-1 items-center"
                            >
                                Cancel
                            </Button>
                            <Button 
                            ...
                            >
                                <RiDeleteBin6Line /> Delete Package
                            </Button>
                        </Modal.Footer>
                    </Modal.Dialog>
                </Modal.Container>
